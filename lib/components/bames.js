  ...
  stopTimer1() {
   ...
   // alert("1")
    this.setState({
      ...
      cssDot4: styles.dot,
      cssDot2: styles.dot,
      picContent: 'This is the content of the picture 1 sdfjkjfbh r,grekutge r,hkgkrtu grgj gkj.gerk'
    });
  }
  ...
  render() {
    return (
        ...
        <div style={styles.flexi2}>
            ...
            <picture>
              <source media="(width: 30em)" srcSet={this.state.pic600.toString()} />
              <source media="(width: 37.5em)" srcSet={this.state.pic600.toString()} />
              <source media="(width: 48em)" srcSet={this.state.pic600.toString()}/>
              <source media="(width: 50em)" srcSet={this.state.pic800.toString()} />
            <img style={styles.imageflex} id="myImg" alt="robo" src={this.state.pic.toString()} sizes="100vw" srcSet={this.state.picset.toString()}/>
            {/* <img style={styles.imageflex} id="myImg" alt="robo" src={this.state.pic.toString()} /> */}
            </picture>
        </div>
         </div>
    );
